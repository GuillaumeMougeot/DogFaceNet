...
class RandomWeightedAverage(_Merge):
    ...
    def _merge_function(self, inputs):
        alpha = K.random_uniform((BATCH, 1, 1, 1))
...
class WGANGP():
    def __init__(self, used_save=False, filenames=None):
        ...
        if used_save:
            assert filenames!=None, "Provide a file name please."
        ...
        print("Computational Graph for Discriminator built!")
        #-------------------------------
        # Construct Computational Graph
        #         for Generator
        #-------------------------------
        ...
        print("Computational Graph for Generator built!")
    ...
    def build_critic(self):
        ...
        # model.add(Conv2D(16, kernel_size=1, strides=2, input_shape=self.img_shape, padding="same"))
        # model.add(LeakyReLU(alpha=0.2))
        ...
        # model.add(Conv2D(16, kernel_size=1, padding="same", input_shape=self.img_shape))
        # model.add(BatchNormalization(momentum=0.8))
        # model.add(Activation("relu"))
    ...
    def train(self, epochs, batch_size, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            for _ in range(self.n_critic):
                ...
                # print("IS it really fuckkkkkkkkk!")
                # Train the critic

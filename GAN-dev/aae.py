...
class AdversarialAutoencoder():
    ...
    def build_encoder(self):
        ...
        h = Conv2D(64,(3,3),strides=(2,2))(img)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2D(128,(3,3),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2D(256,(3,3),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)
    ...
    def build_decoder(self):
        ...
        h = Conv2DTranspose(512,(3,3))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2DTranspose(256,(2,2),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2DTranspose(128,(3,3),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2DTranspose(1,(4,4),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        img = BatchNormalization()(h)
    ...
    def build_discriminator(self):
        ...
        h = Reshape((1,1,self.latent_dim))(z)
        h = Conv2DTranspose(128,(3,3))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)

        h = Conv2DTranspose(512,(3,3),strides=(2,2))(h)
        h = LeakyReLU(alpha=0.2)(h)
        h = BatchNormalization()(h)
...
if __name__ == '__main__':
    ...
    aae.train(epochs=20000, batch_size=64, sample_interval=200)

...
for epoch in range(start_epoch,max_epoch):
    ...
    # Training
    for images_batch,labels_batch in online_adaptive_hard_image_generator(filenames_train,labels_train,model,mean_loss,batch_size,nbof_subclasses=200):
    ...
    # Save
    model.save(PATH_MODEL + '2019.04.29.dogfacenet_v12.'+str(epoch)+'.h5')
    history_ = np.array([loss,val_loss,acc,val_acc])
    np.save(PATH_SAVE+'2019.04.29.dogfacenet_v12.'+str(epoch)+'.h5',history_)

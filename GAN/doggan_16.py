...
PATH_SAVE = '../output/images/dcgan/images/'
...
class DCGAN():
    ...
    def build_discriminator(self):
        ...
        # for l in [128,128,256,256,512]:
        #     model.add(Conv2D(l, kernel_size=3, strides=2))
        #     model.add(BatchNormalization(momentum=0.8))
        #     model.add(LeakyReLU(alpha=0.2))
    ...
    def train(self, epochs, batch_size=128, save_interval=50, epoch_start=0, filename=""):
        ...
        for epoch in range(epoch_start, epochs):
            ...
            if epoch>=2000 and epoch%(4*save_interval)==0:
                self.generator.save_weights(PATH_MODEL+filename+'_generator.'+str(epoch)+'.h5')
                self.discriminator.save_weights(PATH_MODEL+filename+'_discriminator.'+str(epoch)+'.h5')
...
if __name__ == '__main__':
    ...
    dcgan.train(epochs=20000, batch_size=32, save_interval=200, epoch_start=0, filename='2019.05.21.doggan_16')
    # dcgan.eval("test")